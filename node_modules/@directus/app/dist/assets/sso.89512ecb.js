...
AUTH_GOOGLE_DEFAULT_ROLE_ID=`),e("span",{class:"hljs-string"},'"XXXX"'),s(),e("span",{class:"hljs-comment"},"# Replace XXXX with the role ID you would want for new users. If this is not properly configured, new users will not have access to Directus"),s(`
`)])],-1),b=e("ol",{start:"8"},[e("li",null,[s("Now you can see a nice functional "),e("code",null,"Login with Google"),s(" button on Directus login page.")])],-1),D=e("h2",{id:"seamless-sso"},[s("Seamless SSO "),e("a",{class:"header-anchor",href:"#seamless-sso"},"#")],-1),k=e("p",null,"While sometimes you want your users to directly have access to Directus Application, in other cases you may need to fetch private data from Directus in your client using external providers. In this cases, it is needed a special configuration to work across domains, but is simple as:",-1),X=e("ol",null,[e("li",null,[s("Setup an external provider. You have some examples on "),e("a",{href:"#supported-sso-mechanisms"},"Supported SSO mechanisms")]),e("li",null,[s("Allow cookie to be accessible across domains. Put the following configuration on "),e("code",null,".env"),s(":")])],-1),T=e("pre",null,[e("code",{class:"language-sh"},[s("REFRESH_TOKEN_COOKIE_DOMAIN="),e("span",{class:"hljs-string"},'"XXXX"'),s(),e("span",{class:"hljs-comment"},'# Replace XXXX with the domain of your Directus instance. For example "directus.myserver.com"'),s(`
...
`)])])])])])],-1),H={setup(x,{expose:t}){const o={title:"Single Sign-On (SSO)",modularExtension:!1};return t({frontmatter:o}),(L,U)=>{const r=l("router-link"),a=l("DocsWrapper");return i(),c(a,{frontmatter:o},{default:n(()=>[e("div",h,[d,p,g,m,e("p",null,[_,u(r,{to:"/docs/configuration/config-options/#sso-oauth2-and-openid"},{default:n(()=>[f]),_:1})]),y,O,w,S,E,v,j,I,b,D,k,X,T,A,C,G,R])]),_:1})}}};export{H as default};
