...
`)])],-1),ls=s("h5",{id:"examples"},[e("Examples "),s("a",{class:"header-anchor",href:"#examples"},"#")],-1),rs=s("pre",null,[s("code",{class:"language-graphql"},[s("span",{class:"hljs-keyword"},"query"),e(` {
	revisions {
		id
		data
		delta
...
`)])],-1),is=s("hr",null,null,-1),cs=s("h2",{id:"retrieve-a-revision"},[e("Retrieve a revision "),s("a",{class:"header-anchor",href:"#retrieve-a-revision"},"#")],-1),hs=s("p",null,"List an existing revision by primary key.",-1),ds={class:"two-up"},_s={class:"left"},ps=s("h3",{id:"query-parameters-2"},[e("Query Parameters "),s("a",{class:"header-anchor",href:"#query-parameters-2"},"#")],-1),us=e("Supports all "),vs=e("global query parameters"),ms=e("."),fs=s("h3",{id:"returns-2"},[e("Returns "),s("a",{class:"header-anchor",href:"#returns-2"},"#")],-1),gs=s("p",null,[e("Returns the requested "),s("a",{href:"#the-revision-object"},"revision object"),e(".")],-1),ys=s("div",{class:"right"},[s("h3",{id:"rest-api-2"},[e("REST API "),s("a",{class:"header-anchor",href:"#rest-api-2"},"#")]),s("pre",null,[s("code",null,`GET /revisions/:id
...
`)])])],-1),ws={setup(js,{expose:r}){const a={title:"Revisions",modularExtension:!1,pageClass:"page-reference"};return r({frontmatter:a}),(bs,qs)=>{const n=l("router-link"),i=l("DocsWrapper");return c(),h(i,{frontmatter:a},{default:t(()=>[s("div",d,[s("div",_,[s("div",p,[s("blockquote",null,[s("p",null,[u,o(n,{to:"/docs/getting-started/glossary/#revisions"},{default:t(()=>[v]),_:1}),m])])]),f]),g,y,s("div",j,[s("div",b,[s("div",q,[x,s("p",null,[w,k,R,E,P,o(n,{to:"/docs/reference/system/activity/"},{default:t(()=>[T]),_:1}),S]),L,C,D,Q,A])]),G]),B,H,I,s("div",O,[s("div",N,[V,W,s("p",null,[M,o(n,{to:"/docs/reference/query"},{default:t(()=>[F]),_:1}),z]),J,s("p",null,[K,o(n,{to:"/docs/reference/query/#limit"},{default:t(()=>[U]),_:1}),X,Y,Z])]),s("div",$,[ss,es,s("p",null,[o(n,{to:"/docs/reference/introduction/#search-http-method"},{default:t(()=>[ts]),_:1})]),ns,os,as,ls,rs])]),is,cs,hs,s("div",ds,[s("div",_s,[ps,s("p",null,[us,o(n,{to:"/docs/reference/query"},{default:t(()=>[vs]),_:1}),ms]),fs,gs]),ys])])]),_:1})}}};export{ws as default};
