import{r as l,p as c,q as u,w as o,B as e,t as a,P as t}from"./vendor.764dd834.js";const h={class:"markdown-body"},d=t("Custom Modules are completely open-ended components that allow you to create new experiences within the Directus platform. "),p=t("Learn more about Modules"),m=t("."),_=e("h2",{id:"extension-entrypoint"},[t("Extension Entrypoint "),e("a",{class:"header-anchor",href:"#extension-entrypoint"},"#")],-1),f=e("p",null,[t("The entrypoint of your module is the "),e("code",null,"index"),t(" file inside the "),e("code",null,"src/"),t(" folder of your extension package. It exports a configuration object with options to configure the behavior of your module. When loading your module, this object is imported by the Directus host.")],-1),g=e("p",null,"Example of an entrypoint:",-1),y=e("pre",null,[e("code",{class:"language-js"},[e("span",{class:"hljs-keyword"},"import"),t(" ModuleComponent "),e("span",{class:"hljs-keyword"},"from"),t(),e("span",{class:"hljs-string"},"'./module.vue'"),t(`;
...
export default {};
<\/script>
`)],-1),L=e("p",null,[t("A route component provides an blank canvas for creating anything you need. You can use the globally registered "),e("code",null,"private-view"),t(" component to get access to Directus\u2019 page structure consisting of the module bar, the navigation, the sidebar, the header and the main content area.")],-1),N=e("div",{class:"warning hint"},[e("div",{class:"hint-title"},"Enable the Module"),e("p",null,"Before a module appears in the module bar, it has to be enabled inside the project settings.")],-1),O=e("div",{class:"warning hint"},[e("div",{class:"hint-title"},"Vue Version"),e("p",null,"The Directus App uses Vue 3. There might be 3rd party libraries that aren\u2019t yet compatible with Vue 3.")],-1),F=e("h2",{id:"accessing-internal-systems"},[t("Accessing Internal Systems "),e("a",{class:"header-anchor",href:"#accessing-internal-systems"},"#")],-1),G=e("p",null,[t("To access internal systems like the API or the stores, you can use the "),e("code",null,"useApi()"),t(" and "),e("code",null,"useStores()"),t(" composables exported by the "),e("code",null,"@directus/extensions-sdk"),t(" package. They can be used inside a "),e("code",null,"setup()"),t(" function like this:")],-1),H=e("pre",null,[e("code",{class:"language-js"},[e("span",{class:"hljs-keyword"},"import"),t(" { useApi, useStores } "),e("span",{class:"hljs-keyword"},"from"),t(),e("span",{class:"hljs-string"},"'@directus/extensions-sdk'"),t(`;
...
<\/script>
`)],-1),Q=e("p",null,"In the above example, you can see that:",-1),U=e("ul",null,[e("li",null,[t("The "),e("code",null,"api"),t(" field gets injected into the component and becomes available as an attribute of the component (ie "),e("code",null,"this.api"),t(")")]),e("li",null,[t("When the component is mounted, it uses "),e("code",null,"this.api.get"),t(" to request a list of all available collections")]),e("li",null,"The names of the collections are rendered into a list in the component\u2019s template"),e("li",null,"a button is added with a method that logs all the data for the collections to the console")],-1),X=e("p",null,[t("This is just a basic example. A more efficient way to access and work with the list of collections would be to get an instance of the "),e("code",null,"collectionsStore"),t(" using the provided "),e("code",null,"stores"),t(" and accessing "),e("code",null,"stores.useCollectionsStore()"),t(", but that\u2019s beyond the scope of this guide.")],-1),oe={setup(Z,{expose:i}){const s={title:"Custom Modules",modularExtension:!0};return i({frontmatter:s}),($,ee)=>{const n=l("router-link"),r=l("DocsWrapper");return c(),u(r,{frontmatter:s},{default:o(()=>[e("div",h,[e("blockquote",null,[e("p",null,[d,a(n,{to:"/docs/getting-started/glossary/#modules"},{default:o(()=>[p]),_:1}),m])]),_,f,g,y,b,e("ul",null,[v,w,e("li",null,[j,x,a(n,{to:"/docs/getting-started/glossary/#material-icons"},{default:o(()=>[k]),_:1}),A]),T,C,V,I]),S,D,E,M,B,P,R,W,q,L,N,O,F,G,H,Y,z,J,K,Q,U,X])]),_:1})}}};export{oe as default};
