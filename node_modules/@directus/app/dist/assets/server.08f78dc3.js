...
`)])])])],-1),Y=s("hr",null,null,-1),ns={setup(Z,{expose:o}){const l={title:"Server",modularExtension:!1,pageClass:"page-reference"};return o({frontmatter:l}),($,ss)=>{const a=t("router-link"),c=t("DocsWrapper");return h(),i(c,{frontmatter:l},{default:n(()=>[s("div",p,[s("div",d,[s("div",u,[s("blockquote",null,[s("p",null,[g,r(a,{to:"/docs/getting-started/glossary/#projects"},{default:n(()=>[_]),_:1}),f])])]),m]),j,y,v,b,q,k,w,S,T,P,A,I,x,G,E,s("div",R,[s("div",L,[Q,O,s("div",D,[H,s("p",null,[B,r(a,{to:"/docs/reference/system/settings/#the-settings-object"},{default:n(()=>[C]),_:1}),V,N,U])]),W,z]),F]),J,K,M,X,Y])]),_:1})}}};export{ns as default};
